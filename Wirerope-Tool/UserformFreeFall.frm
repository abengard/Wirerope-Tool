VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} UserformFreeFall 
   Caption         =   "Free Fall Results"
   ClientHeight    =   9590.001
   ClientLeft      =   120
   ClientTop       =   470
   ClientWidth     =   11860
   OleObjectBlob   =   "UserformFreeFall.frx":0000
   StartUpPosition =   1  'Fenstermitte
End
Attribute VB_Name = "UserformFreeFall"
        ...
        For i = 1 To 100
            ...
            If Me.ListBoxpossibleWireRopes.Text = .Cells(i, 1) Then
                ...
                ElseIf n >= 51 Then
                    ...
                    If WireRopeTool.ComboBox2 = "Deutsch" Then
            
                        Me.LabelTP€.Caption = "Bitte Anfragen"
                        Me.LabelPWR€.Caption = "Bitte Anfragen"
                
                    ElseIf WireRopeTool.ComboBox2 = "English" Then
            
                        Me.LabelTP€.Caption = "Please Request"
                        Me.LabelPWR€.Caption = "Please Request"
    ...
    With WireRopeTool
        ...
        If .ComboBox2 = "Deutsch" Then
            ...
            With UserformFreeFall
                ...
                .LabelDh.Caption = "Fallhöhe [m]:"
                .LabelV.Caption = "Geschwindigkeit [m/s]:"
        ...
        ElseIf .ComboBox2 = "English" Then
            ...
            With UserformFreeFall
                ...
                .LabelDh.Caption = "Drop height [m]:"
                .LabelV.Caption = "Velocity [m/s]:"
